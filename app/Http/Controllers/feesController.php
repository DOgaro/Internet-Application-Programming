...
class feesController extends Controller
{
	...
	public function index(){
		...
		return view('101485.search')->with('fees', $fees)->with('total', $total);
	...
	public function search(Request $request){
		...
		return view('101485.result')->with('fees', $fees);
	}
	...
	public function view($student_no){
        ...
        return view('101485.finder')->with('fee', $fee);
    }
    ...
    public function find(Request $request){
        ...
        return view('101485.searchresult')->with('fees', $fees);
    }
}
